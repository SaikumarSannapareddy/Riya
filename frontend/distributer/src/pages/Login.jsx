...
const AdminLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const response = await apiClient.post(apiEndpoints.DistributerLogin, {
        email: userId,
        password: password,
      });
      ...
      if (response.status === 200) {
        ...
        localStorage.setItem("distributorId", data.id); // Store distributor ID
      ...
      setError("An error occurred. Maybe your login credentials are incorrect.");
    }
  };
