...
const TestimonialsManagement = () => {
  ...
  const fetchTestimonials = async () => {
    try {
      setLoading(true);
      const response = await apiClient.get(apiEndpoints.Testimonials1);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditing) {
        ...
        await apiClient.put(apiEndpoints.Testimonialsupdate1, formData, {
          headers: {
        ...
        await apiClient.post(apiEndpoints.TestimonialAdding1, formData, {
          headers: {
            'Content-Type': 'multipart/form-data'
          }
        });
  ...
  const handleDelete = async (id) => {
    ...
    try {
      setLoading(true);
      await apiClient.delete(`${apiEndpoints.Testimonialsdelete1}/${id}`);
      fetchTestimonials();
    } catch (err) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">Distributor Reviews Management</h1>
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-8">
        <h2 className="text-xl font-semibold mb-4">
          {isEditing ? "Edit Distributor Review" : "Add New Distributor Review"}
        </h2>
      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <h2 className="text-xl font-semibold p-6 border-b">All Distributor Reviews</h2>
        ...
        {loading && !testimonials.length ? (
          ...
          <div className="text-center py-12 text-gray-500">
            No Distributor Reviews found. Add your first one above.
          </div>
        ) : (
