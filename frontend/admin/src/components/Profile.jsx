  ...
  const sections = [
    {
      ...
      fields: [
        { label: "Address", value: profile?.originalLocation || "N/A", icon: <FaMapMarkerAlt style={{ color: "#007bff" }} /> },
        { label: "Mobile Number", value: profile?.mobileNumber || "N/A", icon: <FaPhone style={{ color: "#28a745" }} /> },
        { label: "Email", value: profile?.email || "N/A", icon: <FaEnvelope style={{ color: "#17a2b8" }} /> },
      ],
    },
   
    {
      ...
      fields: [
        ...
        { label: "Password", value: profile?.password || "N/A", icon: <FaEye style={{ color: "#dc3545" }} /> },
