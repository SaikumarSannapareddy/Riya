...
const TestimonialsManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditing) {
        ...
        await apiClient.put(apiEndpoints.Testimonialsupdate, formData, {
          headers: {
        ...
        await apiClient.post(apiEndpoints.TestimonialAdding, formData, {
          headers: {
            'Content-Type': 'multipart/form-data'
          }
        });
  ...
  const handleDelete = async (id) => {
    ...
    try {
      setLoading(true);
      await apiClient.delete(`${apiEndpoints.Testimonialsdelete}/${id}`);
      fetchTestimonials();
    } catch (err) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <h2 className="text-xl font-semibold p-6 border-b">All Testimonials</h2>
