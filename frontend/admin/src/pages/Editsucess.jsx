...
const AdminDashboard = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  const fetchBusinessDetails = async () => {
    try {
      ...
      if (response.data.sliderImages) {
        setSliderImages(response.data.successImages);
      }
  ...
  const uploadSliderImage = async (e) => {
    ...
    formData.append('successImage', selectedSliderFile);

    try {
      setSliderImageLoading(true);
      const response = await apiClient.put(
        apiEndpoints.Successstories, 
        formData, 
        {
          headers: {
  ...
  const deleteSliderImage = async (id) => {
    ...
    try {
      setSliderImageLoading(true);
      await apiClient.delete(`${apiEndpoints.Successstories}/${id}`);
            ...
            <div className="flex-grow p-6 bg-gray-100">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 mb-4">
                  Upload slider images that will be displayed on your website's homepage.
                </p>
                ...
                <div className="mb-6">
                  <h3 className="text-lg font-medium mb-4">Current Slider Images</h3>
