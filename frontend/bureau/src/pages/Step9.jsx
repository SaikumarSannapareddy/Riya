...
const Step9 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formDataToSend = {
      ...
      partnerCreatedBy: selectedOptions.Created_by_preference || "Any",
      ...
      motherTonguePreferences: selectedOptions.Mother_Toungue_Preferences || "Any",
      ...
      partnerOccupationPreferences: processPreferences(selectedOptions2.Occupation_Preference),
      ...
      flatPreference: processPreferences(selectedOptions3.Apartment_Flats_Preference),
