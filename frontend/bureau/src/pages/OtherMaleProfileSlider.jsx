    ...
    const fetchProfiles = async () => {
      try {
        const response = await apiClient.get(
          `${apiEndpoints.fetchotherbureau}/${bureauId}/male?page=1&limit=10`
        );
    ...
    <div className="bg-gray-100 p-4 rounded-lg relative">
      ...
      <div className="flex items-center justify-between mb-1">
        <h1 className="text-lg sm:text-3xl font-bold text-gray-800 tracking-tight leading-snug flex items-center mb-2">
          <span className="text-purple-700">{t("otherbureaumale")}</span>
        </h1>
        <h1>
      ...
      <div className="flex justify-center mt-6">
        <NavLink
          to={`/other-male-profiles/${bureauId}/male`}
...
export default OtherMaleProfileSlider;
