...
const SuperAdminFemaleProfiles = () => {
      ...
      if (bureauId && gender) {
        try {
          ...
          if (response.data && Array.isArray(response.data.users)) {
            const processed = response.data.users.map(profile => ({
              ...profile,
            ...
            // Filter only "Other Mediater Profile"
            const mediatorProfiles = processed.filter(p => p.createdBy === 'Other Mediater Profile');
            setProfiles(mediatorProfiles);
            setFilteredProfiles(mediatorProfiles);
            setCounters(response.data.counters || {});
            setTotalCount(mediatorProfiles.length);
          } else {
...
export default SuperAdminFemaleProfiles;
