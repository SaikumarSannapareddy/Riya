    ...
    <div className="min-h-screen p-4 bg-gray-100 text-gray-800">
     <div className="sticky top-0 bg-gray-100 z-10 py-4 mb-4">
        <div className="flex items-center mb-4">
          ...
          />
          <h1 className="text-2xl font-semibold">Other Female Profiles</h1>
        </div>

        <div className="flex justify-center space-x-4 mb-4">
 
 <a
   href={`/web-other-male-profiles/${bureauId}/male`}
   className="py-2 px-4 rounded-full bg-gray-300 text-gray-600  hover:bg-blue-100 hover:text-blue-600 text-center"
 >
   Male
 </a>
 <a
