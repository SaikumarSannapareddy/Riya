...
const BureauImageUpload = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiClient.post(`${apiEndpoints.GalleryUpload}`, formDataToSend, {
        headers: {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await apiClient.delete(`${apiEndpoints.Deletegallery}/${imageIdToDelete}`);
      if (response.status === 200) {
      ...
      {uploading ? (
        ...
        <div className="h-auto bg-gray-100 py-10 px-4 mt-20 mb-20">
          ...
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg h-auto">
            ...
            <div className="mt-8">
              <h3 className="text-xl font-semibold text-gray-700 mb-4">Existing Gallery / Succes Stories</h3>
