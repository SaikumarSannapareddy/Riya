...
const AdvancedSearch = () => {
  ...
  // Age dropdown options (individual values)
  const ageOptions = [
  ...
  // Height dropdown options (individual values)
  const heightOptions = [
    { value: 4.0, label: "4'0\" (122 cm)" },
    { value: 4.1, label: "4'1\" (124 cm)" },
    { value: 4.2, label: "4'2\" (127 cm)" },
    { value: 4.3, label: "4'3\" (130 cm)" },
    { value: 4.4, label: "4'4\" (132 cm)" },
    { value: 4.5, label: "4'5\" (135 cm)" },
  ...
  // Selected age and height values
  const [selectedAgeMin, setSelectedAgeMin] = useState(18);
  const [selectedAgeMax, setSelectedAgeMax] = useState(25);
  const [selectedHeightMin, setSelectedHeightMin] = useState(5.1);
  const [selectedHeightMax, setSelectedHeightMax] = useState(5.5);
  ...
  // Handle age min/max selection
  const handleAgeMinChange = (selectedValue) => {
    setSelectedAgeMin(parseInt(selectedValue));
    setAgeRange({ ...ageRange, min: parseInt(selectedValue) });
  };

  const handleAgeMaxChange = (selectedValue) => {
    setSelectedAgeMax(parseInt(selectedValue));
    setAgeRange({ ...ageRange, max: parseInt(selectedValue) });
  };

  // Handle height min/max selection
  const handleHeightMinChange = (selectedValue) => {
    setSelectedHeightMin(parseFloat(selectedValue));
    setHeightRange({ ...heightRange, min: parseFloat(selectedValue) });
  };

  const handleHeightMaxChange = (selectedValue) => {
    setSelectedHeightMax(parseFloat(selectedValue));
    setHeightRange({ ...heightRange, max: parseFloat(selectedValue) });
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-6 px-3 py-6">
              ...
              <section className="shadow-2xl bg-white px-2 py-4 rounded">
                ...
                <div className="mb-[20px] rounded-lg">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="flex-1">
                      <label className="block text-sm text-gray-600 mb-1">From Age</label>
                      <div className="relative">
                        <select
                          value={selectedAgeMin}
                          onChange={(e) => handleAgeMinChange(e.target.value)}
                          className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-red-500 focus:border-red-500 appearance-none bg-white"
                        >
                    ...
                    <div className="flex-1">
                      <label className="block text-sm text-gray-600 mb-1">To Age</label>
                      <div className="relative">
                        <select
                  ...
                  <div className="mt-2 text-sm text-gray-600">
                    Selected: {selectedAgeMin} to {selectedAgeMax} years
                  </div>
                </div>
                ...
                <div className="mb-[20px] rounded-lg">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="flex-1">
                      <label className="block text-sm text-gray-600 mb-1">From Height</label>
                      <div className="relative">
                        <select
                          value={selectedHeightMin}
                    ...
                    <div className="flex-1">
                      <label className="block text-sm text-gray-600 mb-1">To Height</label>
                      <div className="relative">
                        <select
                          value={selectedHeightMax}
                  ...
                  <div className="mt-2 text-sm text-gray-600">
                    Selected: {heightOptions.find(opt => opt.value === selectedHeightMin)?.label} to {heightOptions.find(opt => opt.value === selectedHeightMax)?.label}
                  </div>
                </div>
              </section>
