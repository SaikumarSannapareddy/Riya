...
import { FaArrowLeft, FaWhatsapp, FaEnvelope, FaPhone,FaLightbulb, FaMoneyCheckAlt, FaChartLine, FaMoneyBillWave, FaUserTie,
  ...
  FaMapMarker,FaDownload, FaCheck,FaClock,FaPhoneAlt,
...
const OtherBureauProfileView =  (props)  => {
...
},
{
  ...
  icon: <FaUsers style={{ color: "#007bff" }} />, // Blue icon for the title
  fields: [
    { label: "Family Type", value: profile?.familyType || "NO DATA", icon: <FaHome style={{ color: "#28a745" }} /> }, // Green Home icon
    { label: "Family Value", value: profile?.familyValue || "NO DATA", icon: <FaGem style={{ color: "#ffc107" }} /> }, // Yellow Gem icon
    { label: "Father Employee", value: profile?.fatherEmployee || "NO DATA", icon: <FaBriefcase style={{ color: "#17a2b8" }} /> }, // Teal Briefcase icon
    { label: "Father Occupation", value: profile?.fatherOccupied || "NO DATA", icon: <FaUserTie style={{ color: "#6f42c1" }} /> }, // Purple User Tie icon
    { label: "Mother Employee", value: profile?.motherEmployee || "NO DATA", icon: <FaBriefcase style={{ color: "#e83e8c" }} /> }, // Pink Briefcase icon
    { label: "Mother Occupation", value: profile?.motherOccupied || "NO DATA", icon: <FaUser style={{ color: "#fd7e14" }} /> }, // Orange User icon
    { label: "Total Brothers", value: profile?.totalBrothers || "NO DATA", icon: <FaMale style={{ color: "#20c997" }} /> }, // Cyan Male icon
    { label: "Married Brothers", value: profile?.marriedBrothers || "NO DATA", icon: <FaRing style={{ color: "#dc3545" }} /> }, // Red Ring icon
    { label: "Total Sisters", value: profile?.totalSisters || "NO DATA", icon: <FaFemale style={{ color: "#6610f2" }} /> }, // Violet Female icon
    { label: "Married Sisters", value: profile?.marriedSisters || "NO DATA", icon: <FaRing style={{ color: "#17a2b8" }} /> }, // Teal Ring icon
  ],
},
{
...
// Address Preferences
  ...
  const handleCall = () => {
    if (profile.mobileNumber) {
      window.location.href = `tel:${profile.mobileNumber}`;
    } else {
  ...
  const handleSendWhatsApp = () => {
    const phoneNumber = profile.mobileNumber.replace(/[^\d]/g, ""); // clean number
    const message = encodeURIComponent(
      `Hello ${profile.name || ""}, I’m contacting you via WhatsApp.`
    );
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-800 p-1" ref={profileRef}>
...
<div className="w-full h-full shadow-lg relative">
      {/* Header */}
      <div className="absolute top-0 left-0 right-0  bg-opacity-5 flex justify-between items-center  z-30">
        <FaArrowLeft className="text-grey cursor-pointer" size={24} 
...
<div className="w-full h-[40px] shadow-lg z-20 ">
 ...
 <div className="pt-6 mb-3">
      <div className="w-full">
        ...
        <div className="bg-white shadow-lg p-6 ">
                       <h1 className="text-2xl font-bold text-gray-800 mb-4">Bureau Contact Details :</h1>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl w-80 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Do you want to send a WhatsApp message to{" "}
              <span className="font-bold">{profile.mobileNumber}</span>?
            </p>
...
export default OtherBureauProfileView;
